...
######################################BO-Framework#########################################
def BO_framework_ext(X_set, y_set, kernel, acquisition_function, represtentation ='vector', 
                start_set_size = 0.1, bo_n_iteration = 20, gp_loop_fit = False, 
                reproducibility = False, trial = 0, UCB_lambda = 0, smart_selection = 'none'):
    '''
    ...
    match smart_selection:
        case 'min_similarity':
            ...
            train_idx = cover_space_no_repeat(gram_matrix=k, number_of_samples= n_train_samples,random_state=rnd_state) 
